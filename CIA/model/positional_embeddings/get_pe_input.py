...
def get_pe_input(
    dataloader_generator, x_embed, h, metadata_dict, pe_input_type, event_representation
):
    ...
    if pe_input_type == "index":
        ...
        indices = torch.linspace(0, length - 1, length, device=x_embed.device)
        ...
        if event_representation:
            ...
            elapsed_time_channelized = elapsed_time.repeat_interleave(
                num_channels, dim=1
            )
